...
async def home_callback_handler(bot, query):
    ...
    keybord = InlineKeyboardMarkup([  
                    [InlineKeyboardButton("📢 Updates", url="https://t.me/know_about_loxxd"),
                    InlineKeyboardButton("💬 Support", url="https://t.me/Mcsupportgroup")],
                    [InlineKeyboardButton("🛠️ Help", callback_data='help'),
		            InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
                    [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://t.me/loxxd007")]
		  ])
